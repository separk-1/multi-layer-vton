...
python resize.py \
  --input_dir datasets/VITON-HD/test/image \
  --output_dir datasets/VITON-HD/test/image \
  --width 576 \
  --height 768
...
python extract_densepose.py \
  ...
  --input_dir datasets/VITON-HD/test/image \
  --output_dir datasets/VITON-HD/test/image-densepose \
  --width 576 \
  --height 768
...
python extract_upper_cloth.py \
  --input_dir datasets/VITON-HD/test/image \
  --output_dir datasets/VITON-HD/test/agnostic-mask \
  --densepose_dir datasets/VITON-HD/test/image-densepose \
  --naturality 1 \
  --ratio 0.1 \
  --vest 1 \
  --vest_padding 10
